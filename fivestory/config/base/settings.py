...
DEFAULT_SECRET_KEY = '98#*&237rnasjdv897cretdefaultkey90sJ*&F#j8907a)*'
SECRET_KEY = os.environ.get('SECRET_KEY', DEFAULT_SECRET_KEY)

DEBUG = True
TEMPLATE_DEBUG = True
ALLOWED_HOSTS = ['*'] #TODO: change this once we have a domain
ROOT_URLCONF = 'fivestory.config.base.urls'
WSGI_APPLICATION = 'fivestory.config.base.wsgi.application'
